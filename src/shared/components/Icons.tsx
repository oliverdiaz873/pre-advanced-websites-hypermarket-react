/**
 * Componente que define y agrupa todos los iconos SVG utilizados en la aplicación.
 * Utiliza el elemento <symbol> para definir los iconos sin renderizarlos directamente,
 * permitiendo reutilizarlos en cualquier parte usando <svg><use href="#icon-[nombre]" /></svg>.
 * Esto mejora el rendimiento general y facilita el mantenimiento.
 */
const Icons = () => (
